...
$(EXTENSIONS_DIR)/micro_ros_src/src:
	...
	git clone -b rolling https://github.com/ros2/rosidl_typesupport_microxrcedds src/rosidl_typesupport_microxrcedds; \
...
$(EXTENSIONS_DIR)/micro_ros_src/install: $(EXTENSIONS_DIR)/toolchain.cmake $(EXTENSIONS_DIR)/micro_ros_dev/install $(EXTENSIONS_DIR)/micro_ros_src/src
	...
	colcon build \
		...
		-DCMAKE_TOOLCHAIN_FILE=$(EXTENSIONS_DIR)/toolchain.cmake \
